...
const SWAHILI_KEYWORDS = ['habari', 'sawa', 'bei', 'soko', 'mazao', 'wakulima', 'chakula', 'kilimo', 'mbegu', 'maji'];
const KIKUYU_KEYWORDS = ['wĩra', 'mũgũnda', 'irio', 'mbembe', 'mbeca', 'thoko', 'mũrĩmi'];
const LUO_KEYWORDS = ['chiemo', 'puothe', 'cham', 'yath', 'ohala', 'lupo'];
const KALENJIN_KEYWORDS = ['kerichek', 'imbarek', 'chepkwony', 'beek', 'korosio', 'burgeiyot'];
...
const detectLanguage = (message: string): 'english' | 'swahili' | 'kikuyu' | 'luo' | 'kalenjin' => {
...
export const generateResponse = (
  ...
  try {
    ...
    // Continue with English responses as before
